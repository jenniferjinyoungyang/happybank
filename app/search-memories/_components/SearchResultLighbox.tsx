    ...
    >
      ...
      >
        <button
          type="button"
          onClick={onClose}
          className="absolute top-3 right-3 sm:top-4 sm:right-4 flex items-center justify-center h-7 w-7 sm:h-8 sm:w-8 rounded-full bg-neutral-900 shadow-md border border-white/60 hover:bg-neutral-800 focus:outline-none focus:ring-2 focus:ring-indigo-400"
          aria-label="Close"
        >
